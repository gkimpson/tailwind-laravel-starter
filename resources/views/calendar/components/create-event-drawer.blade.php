...
<div id="createEventDrawer" class="fixed right-0 top-0 z-40 h-screen w-80 translate-x-full overflow-y-auto bg-white p-4 transition-transform dark:bg-gray-800" tabindex="-1" aria-labelledby="createEventDrawerLabel" aria-hidden="true">
    ...
    <form action="#" id="newEventForm">
        <div class="space-y-4">
            ...
            <div>
                <label for="new-rrule" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Recurring rule (optional)</label>
                <input
                    type="text"
                    id="new-rrule"
                    name="new-rrule"
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Paste a valid RRULE string. Use the <a href="https://calget.com/tools/rrule-generator" target="_blank" class="text-primary-600 hover:underline dark:text-primary-400">RRULE generator</a> for help.
                </p>
            </div>
            <div>
                <label for="new-recurrence-end" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Recurring end date</label>
                <div class="relative">
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                        <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path
            ...
            <div>
                ...
                <div class="flex items-center space-x-2">
                    <button type="button" class="h-6 w-6 rounded-xs bg-purple-500 ring-2 ring-transparent data-[color-selected=true]:ring-purple-300" data-color-picker-target="newColorsInput" data-color-picker-value="#a855f7"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-indigo-500 ring-2 ring-transparent data-[color-selected=true]:ring-indigo-300" data-color-picker-target="newColorsInput" data-color-picker-value="#6366f1"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-primary-600 ring-2 ring-transparent data-[color-selected=true]:ring-primary-300" data-color-picker-target="newColorsInput" data-color-picker-value="#2563eb"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-pink-500 ring-2 ring-transparent data-[color-selected=true]:ring-pink-300" data-color-picker-target="newColorsInput" data-color-picker-value="#ec4899"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-teal-400 ring-2 ring-transparent data-[color-selected=true]:ring-teal-300" data-color-picker-target="newColorsInput" data-color-picker-value="#14b8a6"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-green-400 ring-2 ring-transparent data-[color-selected=true]:ring-green-300" data-color-picker-target="newColorsInput" data-color-picker-value="#22c55e"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-yellow-300 ring-2 ring-transparent data-[color-selected=true]:ring-yellow-300" data-color-picker-target="newColorsInput" data-color-picker-value="#eab308"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-orange-400 ring-2 ring-transparent data-[color-selected=true]:ring-orange-300" data-color-picker-target="newColorsInput" data-color-picker-value="#f97316"></button>
                    <button type="button" class="h-6 w-6 rounded-xs bg-red-500 ring-2 ring-transparent data-[color-selected=true]:ring-red-300" data-color-picker-target="newColorsInput" data-color-picker-value="#ef4444"></button>
                </div>
            </div>
            <input id="newColorsInput" name="new-color" type="hidden" value="#2563eb" />
            <div>
