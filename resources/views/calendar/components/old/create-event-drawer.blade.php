...
<div id="createEventDrawer" 
     ...
     tabindex="-1" 
     aria-labelledby="createEventDrawerLabel" 
     aria-hidden="true">
    <h5 id="createEventDrawerLabel" class="mb-6 inline-flex items-center text-sm font-semibold uppercase text-gray-500 dark:text-gray-400">
        New Event
    </h5>
    <button type="button"
    ...
    <form action="#" id="newEventForm" class="space-y-4">
        <!-- Title -->
        <div>
            <label for="new-title" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Title</label>
            <input type="text"
                   name="new-title"
                   id="new-title"
        ...
        <!-- Description -->
        <div>
            <label for="new-description" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Description</label>
        ...
        <div>
            <div class="mr-4 flex items-center">
                <input data-collapse-toggle="new-time-range-container"
        ...
        <div>
            ...
            <div class="flex items-center space-x-2">
                <button type="button" 
                        ...
                        data-color-picker-target="newColorsInput" 
