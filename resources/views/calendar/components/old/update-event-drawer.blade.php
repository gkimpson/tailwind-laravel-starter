...
<div id="updateEventDrawer" 
     ...
     tabindex="-1" 
     aria-labelledby="updateEventDrawerLabel" 
     aria-hidden="true">
    <h5 id="updateEventDrawerLabel" class="mb-6 inline-flex items-center text-sm font-semibold uppercase text-gray-500 dark:text-gray-400">
        Update Event
    </h5>
    <button type="button"
    ...
    <form action="#" id="updateEventForm" class="space-y-4">
        <!-- Title -->
        <div>
        ...
        <div>
            <div class="mr-4 flex items-center">
                <input data-collapse-toggle="update-time-range-container"
        ...
        <!-- Location -->
        <div>
            <label for="update-location" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Location</label>
            <div class="relative">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    <svg aria-hidden="true" class="h-5 w-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Guests -->
        <div>
            <label for="update-add-guests" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Add guests</label>
            <div class="relative">
                <input type="search"
            ...
            <div class="mb-5 mt-2 flex space-x-1">
                <div class="relative">
                    <img class="h-8 w-8 rounded-full border-2 border-white dark:border-gray-800" 
                         ...
                         alt="helene avatar" />
                    <a href="#" 
                       class="absolute left-5 top-0 flex h-3.5 w-3.5 items-center justify-center rounded-full border-2 border-white bg-gray-400 hover:bg-gray-500 dark:border-gray-800">
                ...
                <button type="submit" 
                        class="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white bg-gray-700 text-xs font-medium text-white hover:bg-gray-600 dark:border-gray-800 dark:bg-gray-600">
                    +7
                </button>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex items-center space-x-2">
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-purple-500 ring-2 ring-transparent data-[color-selected=true]:ring-purple-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="purple"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-indigo-500 ring-2 ring-transparent data-[color-selected=true]:ring-indigo-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="indigo"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-primary-600 ring-2 ring-transparent data-[color-selected=true]:ring-primary-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="primary"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-pink-500 ring-2 ring-transparent data-[color-selected=true]:ring-pink-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="pink"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-teal-400 ring-2 ring-transparent data-[color-selected=true]:ring-teal-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="teal"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-green-400 ring-2 ring-transparent data-[color-selected=true]:ring-green-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="green"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-yellow-300 ring-2 ring-transparent data-[color-selected=true]:ring-yellow-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="yellow"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-orange-400 ring-2 ring-transparent data-[color-selected=true]:ring-orange-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="orange"></button>
                <button type="button" 
                        class="h-6 w-6 rounded-xs bg-red-500 ring-2 ring-transparent data-[color-selected=true]:ring-red-300" 
                        data-color-picker-target="editColorsInput" 
                        data-color-picker-value="red"></button>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="space-y-3">
                <div class="mr-4 flex items-center">
                    <input id="guest-permission-1-checkbox"
                           type="checkbox"
                           value=""
                ...
                <div class="mr-4 flex items-center">
                    <input id="guest-permission-2-checkbox"
                           type="checkbox"
                           value=""
                           name="guest-permission-checkbox"
                           class="h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600" />
